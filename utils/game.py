...
async def game_winner_determined(w_nft: Nft, l_nft: Nft) -> None:
    ...
    await nft_dao.edit_by_address(address=w_nft.address, duel=False, arena=False, activated=False)
    await nft_dao.edit_by_address(address=l_nft.address, user_id=w_nft.user_id, duel=False, arena=False, activated=False)
...
async def game_draw(nft_d1: Nft, nft_d2: Nft) -> None:
    ...
    await nft_dao.edit_by_address(address=nft_d1.address, duel=False, arena=False, activated=False)
    await nft_dao.edit_by_address(address=nft_d2.address, duel=False, arena=False, activated=False)
    await db_session.commit()
